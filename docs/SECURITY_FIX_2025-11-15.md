...
```
REDIS_PASSWORD=FzguQno+zQ1K0G3Y2CiWS8Vd8sepTI2ugFzcXMfvIXQ=
```
...
redis-cli -h localhost -p 6379 -a "FzguQno+zQ1K0G3Y2CiWS8Vd8sepTI2ugFzcXMfvIXQ="
```
...
```bash
# Redis (with password)
REDIS_URL=redis://:FzguQno+zQ1K0G3Y2CiWS8Vd8sepTI2ugFzcXMfvIXQ=@redis:6379
...
docker exec nexwave-market-data redis-cli -h redis -p 6379 -a "FzguQno+zQ1K0G3Y2CiWS8Vd8sepTI2ugFzcXMfvIXQ=" ping
# Expected: PONG
