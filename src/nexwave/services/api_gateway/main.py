...
app = FastAPI(
    title="Nexwave API",
    description="Autonomous Trading Agent API for Pacifica Perpetual DEX with x402 Micropayments",
    version="0.2.0",
)
    ...
    try:
        ...
        for pos in positions:
            ...
            position_data.append(
                PositionSchema(
                    symbol=pos.symbol,
                    side=pos.side.upper(),  # Convert to uppercase for frontend
                    amount=pos.amount,
                    ...
                    leverage=leverage,
                    notional=notional,
                    quantity=pos.amount,  # Same as amount, for frontend compatibility
