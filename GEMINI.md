...
**Nexwave** is an x402-native data intelligence platform and autonomous trading agent built for the Solana x402 Hackathon. It provides real-time market data, whale tracking, and algorithmic trading for the Pacifica perpetual DEX on Solana.
...
- **x402 Protocol:** Check https://hackathon.x402.org/docs

---

**Last Updated:** December 5, 2025
**Version:** 2.4.0 (Risk management & volatility-adjusted TP)
**Maintained by:** Nexwave Team
